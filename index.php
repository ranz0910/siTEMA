      ...
      <div class="card bg-light-primary shadow-none">
        <div class="card-body p-4">
          <div class="d-flex align-items-center">
            ...
            <div class="ms-3">
              <h4 class="mb-0 fw-semibold">120</h4>
      ...
      <div class="card bg-light-success shadow-none">
        <div class="card-body p-4">
          <div class="d-flex align-items-center">
            ...
            <div class="ms-3">
              <h4 class="mb-0 fw-semibold">85</h4>
  ...
  <div class="row">
    <div class="col-lg-8 d-flex align-items-stretch">
      <div class="card w-100">
        <div class="card-body">
          <h5 class="card-title fw-semibold">Statistik Penempatan Magang 2024</h5>
          <div id="chart"></div>
        </div>
      </div>
    </div>
            ...
            <table class="table text-nowrap mb-0 align-middle">
              <thead class="text-dark fs-4">
                <tr>
                  ...
                  <th class="border-bottom-0">
                    <h6 class="fw-semibold mb-0">Perusahaan Tujuan</h6>
                  </th>
                  <th class="border-bottom-0">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="border-bottom-0">
                    <h6 class="fw-semibold mb-1">Budi Setiadi</h6><span class="fw-normal">Informatika</span>
                  </td>
                  <td class="border-bottom-0">PT. Teknologi Indonesia</td>
                  <td class="border-bottom-0"><span class="badge bg-warning rounded-3 fw-semibold">Pending</span></td>
                  <td class="border-bottom-0">12 Jan 2024</td>
                </tr>
                <tr>
                  <td class="border-bottom-0">2</td>
                  <td class="border-bottom-0">
                    <h6 class="fw-semibold mb-1">Ani Wijaya</h6><span class="fw-normal">Sistem Informasi</span>
                  </td>
                  <td class="border-bottom-0">Bank BCA</td>
                  <td class="border-bottom-0"><span class="badge bg-success rounded-3 fw-semibold">Diterima</span></td>
                  <td class="border-bottom-0">10 Jan 2024</td>
                </tr>
              </tbody>
            </table>
          </div>
