     ...
     <?php 
        ...
        switch ($page) {
          ...
          case 'data_perusahaan':
            include 'layout/data/data_perusahaan.php';
            break;
          ...
          // Jurusan
          case 'data_jurusan':
            include 'layout/data/data_jurusan.php';
            break;
          ...
          case 'edit_profile_jurusan':
              include 'layout/edit/edit_profile_jurusan.php';
              break;

          // Prodi
          case 'data_prodi':
              include 'layout/data/data_prodi.php';
              break;
          ...
          // Mahasiswa
          case 'data_mahasiswa':
            include 'layout/data/data_mahasiswa.php';
            break;
          ...
          case 'edit_profile_mahasiswa':
              include 'layout/edit/edit_profile_mahasiswa.php';
              break;
