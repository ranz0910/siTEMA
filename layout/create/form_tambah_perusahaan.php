          ...
          <form action="process/perusahaan/TambahPerusahaan.php" method="POST">
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                ...
                <input type="email" name="email_perusahaan" class="form-control" id="email" placeholder="email@perusahaan.ac.id" required>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input type="text" name="alamat_perusahaan" class="form-control" id="alamat" placeholder="Alamat perusahaan" required>
              </div>
              <div class="col-md-6 mb-3">
                <label for="kontakPerusahaan" class="form-label">Kontak Perusahaan</label>
                <input type="text" name="kontak_perusahaan" class="form-control" id="kontak" placeholder="Kontak perusahaan" required>
              </div>
            </div>
