    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form action="process/jurusan/update_profile.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="id_jurusan" value="<?= $data['id'] ?>">

                        <div class="mb-4 text-center">
                            <label class="form-label fw-semibold d-block text-start">Foto Profil Jurusan</label>
                        ...
                        <div class="d-flex justify-content gap-2 mt-5">
                            <a href="index.php?page=profile_jurusan&id=<?= $data['id'] ?>" class="btn btn-light px-4">Batal</a>
